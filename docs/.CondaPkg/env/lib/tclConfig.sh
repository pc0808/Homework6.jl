...
# installed.
TCL_PREFIX='/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/include -fdebug-prefix-map=/Users/runner/miniforge3/conda-bld/tk_1695506005511/work=/usr/local/src/conda/tk-8.6.13 -fdebug-prefix-map=/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -isystem /Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/include -mmacosx-version-min=10.9 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib -L/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/include'
...
# compiled.
TCL_SRC_DIR='/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Users/promiachowdhury/Documents/fall23/6.c25/Homework6/docs/.CondaPkg/env/lib/libtclstub8.6.a'
